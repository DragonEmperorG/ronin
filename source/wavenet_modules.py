...
class ConstantPad1d(Function):
    ...
    def forward(self, input, target_size, dimension, value, pad_start):
        self.target_size = target_size
        self.dimension = dimension
        self.value = value
        self.pad_start = pad_start
...
def constant_pad_1d(input,
                    ...
                    value=0,
                    pad_start=False):
    return ConstantPad1d(target_size, dimension, value, pad_start).apply(input, target_size, dimension, value, pad_start)
